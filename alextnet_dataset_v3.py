...
model_name = 'alexnet_v2_dataset_v3'
...
if (training):
	alexnet_base = GetAlexNetModel()

	optimizer = optim.SGD(alexnet_base.parameters(), lr=0.001, momentum=0.9)
	all_model_names, train_loss = TrainModelV2(model=alexnet_base, criterion=criterion, \
