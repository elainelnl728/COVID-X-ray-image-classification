...
# Model name
model_name = 'ensemble_model_v12_dataset_v3'
...
# Load base models
alexnet_path = './saved_models/alexnet_v2_dataset_v3_5.pth'
alexnet = GetAlexNetModel()
alexnet.load_state_dict(torch.load(alexnet_path))

inception_v3_path = './saved_models/inception_v3_v2_dataset_v3_1.pth'
inception_v3 = GetInceptionV3Model()
inception_v3.load_state_dict(torch.load(inception_v3_path))

vgg16_path = './saved_models/vgg16_v2_dataset_v3_7.pth'
